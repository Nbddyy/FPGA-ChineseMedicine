	...
	begin
		...
		begin
			...
			add_y_0_18b <= mult_r_for_y_18b + mult_g_for_y_18b;/////47R + 157G
			add_y_1_18b <= mult_b_for_y_18b + para_16_18b;////16B + 4096
			
			add_cb_0_18b <= mult_b_for_cb_18b + para_128_18b;///112B + 32768
			add_cb_1_18b <= mult_r_for_cb_18b + mult_g_for_cb_18b;///26R + 86G
			
			add_cr_0_18b <= mult_r_for_cr_18b + para_128_18b;//112R + 32768
			add_cr_1_18b <= mult_g_for_cr_18b + mult_b_for_cr_18b;///102G + 10B
