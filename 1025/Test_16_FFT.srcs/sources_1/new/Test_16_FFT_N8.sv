module Test_16_FFT_N8 (
	...
	output reg signed [18:0] X0_real,
	output reg signed [18:0] X0_imaginary,
	output reg signed [18:0] X1_real,
	output reg signed [18:0] X1_imaginary,
	output reg signed [18:0] X2_real,
	output reg signed [18:0] X2_imaginary,
	output reg signed [18:0] X3_real,
	output reg signed [18:0] X3_imaginary,
	output reg signed [18:0] X4_real,
	output reg signed [18:0] X4_imaginary,
	output reg signed [18:0] X5_real,
	output reg signed [18:0] X5_imaginary,
	output reg signed [18:0] X6_real,
	output reg signed [18:0] X6_imaginary,
	output reg signed [18:0] X7_real,
	output reg signed [18:0] X7_imaginary
);
	...
	*/
	always @(posedge clk or negedge rst_n) begin
		if(~rst_n) begin
			...
			X1_real <= (G1_real * 1019 + 723 * G5_real + 723 * G5_imaginary) / 1019;
		end
	end
	...
	always @(posedge clk or negedge rst_n) begin
		if(~rst_n) begin
			...
			X1_imaginary <= (G1_imaginary * 1019 - 723 * G5_real + 723 * G5_imaginary) / 1019;
		end
	end
	...
	*/
	always @(posedge clk or negedge rst_n) begin
		if(~rst_n) begin
			...
			X3_real <= (G3_real * 1019 - 723 * G7_real + G7_imaginary * 1019) / 1019;
		end
	end
	...
	always @(posedge clk or negedge rst_n) begin
		if(~rst_n) begin
			...
			X3_imaginary <= (G3_imaginary * 1019 - 723 * G7_real - 723 * G7_imaginary) / 1019;
		end
	end
	...
	*/
	always @(posedge clk or negedge rst_n) begin
		if(~rst_n) begin
			...
			X5_real <= (G1_real * 1019 - 723 * G5_real - 723 * G5_imaginary) / 1019;
		end
	end
	...
	always @(posedge clk or negedge rst_n) begin
		if(~rst_n) begin
			...
			X5_imaginary <= (G1_imaginary * 1019 + 723 * G5_real - 723 * G5_imaginary) / 1019;
		end
	end
	...
	*/
	always @(posedge clk or negedge rst_n) begin
		if(~rst_n) begin
			...
			X7_real <= (G3_real * 1019 + 723 * G7_real - 723 * G7_imaginary) / 1019;
		end
	end
	...
	always @(posedge clk or negedge rst_n) begin
		if(~rst_n) begin
			...
			X7_imaginary <= (G3_imaginary * 1019 + 723 * G7_real + 723 * G7_imaginary) / 1019;
		end
	end
