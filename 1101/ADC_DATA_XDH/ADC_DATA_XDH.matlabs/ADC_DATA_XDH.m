 ...
 N = 4096;				%数据样点长度
 f1 = 10000;			%信号1频率（信号的频率是1MHz）变量声明的单位是hz
 f2 = 30000;			%信号2频率（信号的频率是3MHz）变量声明的单位是hz
 Fs = 500000;			%采样频率，（信号的采样频率是50MHz）单位是hz
...
%%%将产生的滤波器系数写入.coe文件中
%%%%%%%%%%%可用于%%%%%%%%%%%%%
	fid = fopen('LPF_ADC_DATA_XDH.coe','W');
